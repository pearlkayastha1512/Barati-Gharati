...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: "#FFF5F7" }, content: { padding: 20, paddingBottom: 40 },
  center: { flex: 1, alignItems: "center", justifyContent: "center", padding: 24, backgroundColor: "#FFF5F7" }, error: { color: "#E63B5F", textAlign: "center" }, backLink: { marginTop: 14, color: "#FF4D6D", fontWeight: "700" },
  topBar: { flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }, iconButton: { width: 40, height: 40, borderRadius: 14, alignItems: "center", justifyContent: "center", backgroundColor: "#FFFEF7", borderWidth: 1, borderColor: "#FFB3BF" }, topTitle: { color: "#3F1D2F", fontSize: 18, fontWeight: "800" },
  hero: { borderRadius: 26, padding: 22, backgroundColor: "#FF4D6D", marginBottom: 18, borderWidth: 1, borderColor: "#FF9AAA" }, eyebrow: { color: "#FFFEF7", fontSize: 11, fontWeight: "700" }, heroTitle: { color: "#FFFFFF", fontSize: 25, fontWeight: "800", marginTop: 10 }, heroSub: { color: "#FFE6EB", marginTop: 5 }, status: { alignSelf: "flex-start", backgroundColor: "#FFFEF7", borderRadius: 20, paddingHorizontal: 12, paddingVertical: 7, marginTop: 16 }, statusText: { color: "#6C2D45", fontSize: 12, fontWeight: "700" },
  card: { borderRadius: 22, padding: 18, borderWidth: 1, borderColor: "#FFB3BF", backgroundColor: "#FFFEF7", marginBottom: 16 }, cardTitle: { color: "#3F1D2F", fontSize: 17, fontWeight: "800", marginBottom: 14 },
