...
import { getMyVendorProfile } from "../../api/vendorDashboard.api";

export default function ReviewsScreen() {
  const reviews = useVendorReviewsStore(
    (state) => state.reviews
  );

  const fetchReviews = useVendorReviewsStore(
    (state) => state.fetchReviews
  );

  const submitReply = useVendorReviewsStore(
    (state) => state.submitReply
  );
