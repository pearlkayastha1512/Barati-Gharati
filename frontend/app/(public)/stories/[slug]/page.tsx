...
import { getWeddingStoryBySlugApi } from "@/services/api/wedding-story.api";
import type {
  WeddingStoryImage,
...
export default async function StoryPage({
      ...
      <section className="py-28">
        <div className="mx-auto grid max-w-7xl gap-20 px-6 lg:grid-cols-[1.2fr_.8fr]">
          ...
          <div>
            ...
            <div className="mt-10 space-y-8 text-lg leading-9 text-gray-600">
              {story.story.map((paragraph: string, index: number) => (
                <p key={index}>
                  {paragraph}
                </p>
              ))}
  ...
  (
    ...
    index: number
              ...
              <div className="col-span-full rounded-3xl bg-white py-20 text-center shadow">
  ...
  .sort(
    (
      a: WeddingStoryTimeline,
      b: WeddingStoryTimeline
    ) => a.sortOrder - b.sortOrder
  )
                 .map(
  (
    item: WeddingStoryTimeline,
    index: number
  ) => (
                    <div
                      key={item.id ?? index}
                ...
                <div className="rounded-3xl border border-rose-100 bg-white py-16 text-center shadow">
                  <p className="text-gray-500">
          ...
          <div className="overflow-hidden rounded-[40px] bg-gradient-to-r from-[#2b0f12] via-[#40161c] to-[#5a1f2a] p-12 text-white shadow-[0_25px_80px_rgba(236,72,153,.25)]">
            <div className="grid items-center gap-10 lg:grid-cols-[1fr_auto]">
              ...
              <div>
                ...
                <p className="mt-6 max-w-2xl text-lg leading-8 text-rose-100">
                  Discover verified photographers, decorators,
                  makeup artists, venues and planners who can
